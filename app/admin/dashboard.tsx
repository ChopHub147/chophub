...
export default function AdminDashboard({
  ...
  const [activeSection, setActiveSection] = useState<
    "menu" | "availability" | "products" | "orders"
  >("menu");
          ...
          {activeSection === "orders" && (
            <div className="pt-5">
              ...
              <p className="mt-1 text-gray-600">
                Orders currently arrive through WhatsApp.
                This workspace will show and organize them
                here after order storage is connected.
              </p>
